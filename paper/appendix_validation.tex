...
\subsection{Brands with Large Divergence}

Table~\ref{tab:divergent_brands} identifies brands where the two measures substantially disagree.

\begin{table}[htbp]
\centering
\caption{Brands with Substantial Measure Divergence}
\label{tab:divergent_brands}
\begin{threeparttable}
\small
\begin{tabular}{lccl}
\toprule
Brand & Foot Traffic & Twitter & Possible Explanation \\
\midrule
\multicolumn{4}{l}{\textit{Our measure more Republican}} \\
[Brand 1] & 0.XX & 0.XX & [Explanation] \\
[Brand 2] & 0.XX & 0.XX & [Explanation] \\
\midrule
\multicolumn{4}{l}{\textit{Our measure more Democratic}} \\
[Brand 1] & 0.XX & 0.XX & [Explanation] \\
[Brand 2] & 0.XX & 0.XX & [Explanation] \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]
\small
\item \textit{Notes}: Brands with absolute difference between foot traffic-based and Twitter-based measures $>$ 0.15. Possible explanations include geographic coverage differences, social media vs. in-store customer divergence, and brand positioning changes over time.
\end{tablenotes}
\end{threeparttable}
\end{table}
